        ...
        <table class="form-table">
            <tbody>
                ...
                <tr style="<?php echo $this->show_setting( $settings[ $this->slug . '-enable' ] ); ?>">
                    ...
                    <td>
                        <input type="text" class="regular-text" name="<?php echo $this->slug; ?>-to-emails" value="<?php echo ( isset( $settings[ $this->slug . '-to-emails' ] ) && ! empty ( $settings[ $this->slug . '-to-emails' ] ) ? esc_attr( $settings[ $this->slug . '-to-emails' ] ) : get_option( 'admin_email' ) ); ?>"/>
